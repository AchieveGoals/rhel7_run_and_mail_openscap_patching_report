...
oscap oval eval --report vulnerability-$(rhcurrdate)-$(hostname -s).html rhel-7.oval.xml

mail -s "openscap-scanner results (post RHSA-$(rhcurrdate)) - $(hostname -s)" -a $(ls -t1 vul*html) your.email@gmail.com
